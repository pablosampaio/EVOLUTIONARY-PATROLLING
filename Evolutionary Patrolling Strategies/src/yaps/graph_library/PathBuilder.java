...
public class PathBuilder {
	 ...
	 * que � deixado para uma etapa posterior. Retorna um novo caminho resultante da opera��o. 
	 * <br><br>
	 * Exemplo: 
	 ...
	 * <br><br>
	 * Recebe: <ul>
	 * <li>sourceNode1, �ndice do n� de origem da 1a areasta "quebrada" (range: [0, n-2])
	 * <li>sourceNode2: �ndice do n� de origem da 2a areatas "quebrada" (range: [srcNode1, n-2])
	 * <li>p: o caminho</ul> 
	 */
	public static Path twoChange(Path path, int srcNode1, int srcNode2) {
		...
		ListView<Integer> partBreverted = new ListView<Integer>(path, srcNode2, srcNode1+1); //isso garante a invers�o, pq srcNode2 > srcNode1
	 ...
	 * Alem disso, invert[i] indica se o trecho que termina em srcNodes[i] vai ou n�o
