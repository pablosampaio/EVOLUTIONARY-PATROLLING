...
public class TestMetrics {
	...
	public static void main(String[] args) {
		...
		list.addVisit(1, 2);  //in instant 1, an agent visited node 2
		list.addVisit(1, 0);  //in instant 1, an agent visited node 0
		list.addVisit(2, 1);
		list.addVisit(4, 1);
		list.addVisit(4, 2);
		list.addVisit(5, 3);
		...
		System.out.printf(" - desvio padrao das visitacoes e das frequencias: %.3f / %.3f \n", freqReport.getStdDevOfVisits(), freqReport.getStdDevOfFrequencies());
